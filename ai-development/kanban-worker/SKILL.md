...
See `references/codex-lane.md` for running Codex CLI as an isolated implementation lane inside a Kanban worker — when to use it, worktree isolation, prompt construction, monitoring, reconciliation checklist, and the `kanban_complete` metadata schema.
