...
class NPUWorker(WorkerBase):
    ...
    def compile_or_warm_up_model(self) -> CompilationTimes:
        ...
        # PATCHED(qwen6): skip _warm_up_atb() -- torch_npu._npu_matmul_add_fp32 segfaults inside
        # atb::OperationSetup (ATB mki_log ostream_insert) under CANN 8.5.0. Warmup is optional (perf-only).
        # if get_ascend_device_type() != AscendDeviceType.A5:
        #     self._warm_up_atb()
