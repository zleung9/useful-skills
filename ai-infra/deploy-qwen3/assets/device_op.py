...
class BaseDeviceAdaptor:
    ...
    def npu_moe_init_routing(
        ...
        *,
        ...
        # PATCHED(qwen6): CANN8.5.0 cannot load aclnnMoeInitRoutingCustom (9.0.1-built custom op).
        # Use the torch_npu built-in npu_moe_init_routing_v2 (same as A5DeviceAdaptor override).
        import torch_npu
