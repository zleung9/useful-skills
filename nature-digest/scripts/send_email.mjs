...
//      `msmtp -a <account> <recipients>`. Default account: "xmu".
...
const account = args.account || process.env.MSMTP_ACCOUNT || "xmu";
...
if (msmtpAvailable()) {
  const from = readFromFromConfig(account) || "zliang8@xmu.edu.cn";
